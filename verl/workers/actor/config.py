...
class ActorConfig:
    ...
    enable_ptd: bool = field(default=False, init=False)
    ptd_coef: float = field(default=1.0, init=False)
    ptd_top_k: int = field(default=64, init=False)
    ptd_kl_penalty: str = field(default="low_var_kl", init=False)
    ptd_kl_direction: str = field(default="forward_kl", init=False)
...
class RefConfig:
    ...
    ptd_top_k: int = field(default=0, init=False)
