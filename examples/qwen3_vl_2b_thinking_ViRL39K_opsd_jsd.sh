...
EXP_NAME=qwen3_vl_2b_thinking_ViRL39K_opsd_jsd
...
CONGI_FILE="examples/configs/config_opsd.yaml"
TRAIN_FILE="/mnt/llm-plus-public/dataset/PAPO_ViRL39K_train_with_cot/data"
...
CUDA_VISIBLE_DEVICES=${CUDA_IDS} python3 -m verl.trainer.main \
    ...
    data.prompt_with_hint_key=prompt_with_gt \
    data.hint_format_prompt=examples/format_prompt/math_perception_opsd.jinja \
    ...
    trainer.val_freq=40 \
    algorithm.enable_opsd=true \
    algorithm.opsd_coef=1.0 \
    algorithm.pid_top_k=-1 \
    algorithm.pid_kl_direction=jsd_kl \
    algorithm.disable_kl=false \
    algorithm.use_kl_loss=false \
    algorithm.kl_coef=0.0 \
    algorithm.enable_pid=false \
    trainer.load_checkpoint_path=/mnt/vlm-ks3/xiangshizhe/vlm-rl-xsz/qwen3_vl_2b_thinking_ViRL39K_opsd_jsd/global_step_80 \
